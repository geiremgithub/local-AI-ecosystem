...
SKRIPT_VERSJON = "v50-full-rag-prosess"
...
def besvar_sporsmal(bruker_sporsmal):
    ...
    # 2. Embedding av spørsmålet via ChromaDB sin embedding-funksjon
    ...
    # 3. Databasesøk med avstander og henting av chunks/vektorer
    ...
    # Beregn antall genererte tokens for ytelsesmåling

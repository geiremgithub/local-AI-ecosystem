    ...
    meldinger = [
        {
            ...
            "content": (
                ...
                "Hvis brukeren spør om eller påstår en verdi som er feil (for eksempel et feil klokkeslett eller en feil tid), "
                "skal du først svare tydelig 'Nei', og deretter oppgi det korrekte svaret basert på kildene. "

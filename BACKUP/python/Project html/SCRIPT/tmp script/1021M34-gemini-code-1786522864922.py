...
def besvar_sporsmal(bruker_sporsmal):
    ...
    meldinger = [
        ...
        "content": (
            ...
            "informasjon i samme setning. dersom det spør om et klokkeslett, skal ai lete i kildefilen og se om det finnes der. dersom spøreren spør om noe fiel. skal en starte setningen med nei, og deretter det riktige svaret."

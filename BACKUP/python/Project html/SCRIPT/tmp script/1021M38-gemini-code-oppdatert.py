...
SKRIPT_VERSJON = "v48-sikret-mot-hallusinasjon"
...
# --- Determinisk søk (Ingen AI-hallusinasjon ved oppslag) ---
        ...
        if any(oi.lower() in doc.lower() for oi in ord_i_sporsmal):
            ...
            if utdrag not in filtrerte_kilder:
                ...
                if kilde_navn not in funnede_filer_hybrid:
                    print(f"[Hybrid-treff] Fant nøkkelord i {kilde_navn}")
...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            # Fanger opp spørsmål om å finne filer/ord og sender dem til deterministisk søk i steden for LLM

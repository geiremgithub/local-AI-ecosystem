...
SKRIPT_VERSJON = "v43-integrert-RAG-prosess"
...
def besvar_sporsmal(bruker_sporsmal):
    ...
    # 1. Tokenisering (utføres i det øyeblikket spørsmålet blir stilt)
    ...
    # 2. Embedding (generering av spørsmål-vektor)
    ...
    # 3. Databasesøk og henting av databasens vektorer basert på spørsmålet
    print("3. Databasesøk...")

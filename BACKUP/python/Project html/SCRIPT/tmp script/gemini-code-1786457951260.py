...
SKRIPT_VERSJON = "v31-vektorer-i-figur"
...
def generer_og_lagre_visuell_figur(bruker_sporsmal, dokumenter, metadataer, avstander, sporsmal_vektor, dokument_vektorer):
    print("[Grafikk] Genererer vektorrom-visualisering med vektortall...")
    try:
        ...
        # Tegn chunks og legg til vektortall i tekstboksen
        for i in range(len(dokumenter)):
            ...
            # Formater de første 4 tallene i vektoren for visning i figuren
        ...
        # Tegn spørsmål og legg til vektortall
        ...
        plt.title("Vektorrom-visualisering av RAG-søk med faktiske vektortall", fontsize=14, fontweight='bold')
...
def besvar_sporsmal(bruker_sporsmal):
    ...
    # Send med vektorene til figur-generatoren

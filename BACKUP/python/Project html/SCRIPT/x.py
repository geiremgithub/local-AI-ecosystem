...
SKRIPT_VERSJON = "v19-terminal-Qwen2.5-7B-med-hastighetsmatling"
...
print("[System] Laster inn Qwen2.5-7B-Instruct (dette kan ta litt tid første gang)...")
ai_modell = pipeline(
    "text-generation",
...
def besvar_sporsmal(bruker_sporsmal):
    ...
    # Beregner omtrentlig hastighet i tokens per sekund

...
SKRIPT_VERSJON = "v52-oppdatert-systemprompt"
...
def besvar_sporsmal(bruker_sporsmal):
    ...
    ord_i_sporsmal = [word.lower().strip('?.,!:;"\'') for word in bruker_sporsmal.split() if len(word.strip('?.,!:;"\'')) > 3]
    ...
    meldinger = [
        {
            ...
            "content": (
                ...
                "232. IKKE forveksle punkt-nummerering (f.eks. '17.' for regel nr 17) med faktiske datoer eller tallverdier.\n"
                "332. Hvis informasjonen ikke finnes, si klart at informasjonen mangler i kildene. Ikke gjett.\n"
...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            if (sp_lower.startswith("hvor finnes") or 
                sp_lower.startswith("finn alle kildefiler") or 
                sp_lower.startswith("hvilke filer") or 
                sp_lower.startswith("finn fil") or
                sp_lower.startswith("hvilken fil")):
                ...
                if match:
                    ...
                    ordet = sp_lower
                    for prefix in [
                        "hvor finnes ordet", "hvor finnes", 
                        "finn alle kildefiler som har ordet", "finn alle kildefiler", 
                        "hvilke filer inneholder", "hvilke filer", 
                        "finn filen som inneholder", "finn kildefilen for", "finn fil", "hvilken fil"
                    ]:

...
SKRIPT_VERSJON = "v38-naturlig-svarformat-flere-mapper"
    ...
    meldinger = [
        {
            "role": "system", 
            "content": (
                "Du er en presis assistent. Svar naturlig og sannferdig på brukerens spørsmål basert utelukkende "
                "på dokumentinnholdet under. Ikke finn på informasjon, og tilpass bekreftelser eller avkreftelser "
                "direkte etter hva dokumentet sier.\n\n"
                f"----- DOKUMENTINNHOLD -----\n{kombinert_kontekst}"
            )
        },
    ]

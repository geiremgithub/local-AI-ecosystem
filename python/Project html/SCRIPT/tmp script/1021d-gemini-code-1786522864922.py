...
SKRIPT_VERSJON = "v38-naturlig-svarformat-flere-mapper-dynamisk"
...
def besvar_sporsmal(bruker_sporsmal):
    ...
    print("3. Databasesøk...")
    sok_resultat = db_samling.query(query_texts=[bruker_sporsmal], n_results=15)
    ...
    for i in range(len(dokumenter)):
        ...
        if kilde not in sett_filer or len(sett_filer) < 5:

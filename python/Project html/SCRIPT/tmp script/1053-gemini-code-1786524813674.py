...
SKRIPT_VERSJON = "v40-unike-bildevisninger"
...
def generer_og_lagre_visuell_figur(bruker_sporsmal, dokumenter, metadataer, avstander, sporsmal_vektor, dokument_vektorer):
    ...
    try:
        ...
        # --- Dynamisk filnavn med talliterasjon hvis filen finnes fra før ---
    ...
    meldinger = [
        {
            ...
            "content": (
                ...
                "Svar direkte på spørsmålet ved å bruke gyldige norske ord og uttrykk, basert utelukkende "
                "på oppgitt dokumentinnhold. Ikke bruk oppkonstruerte eller feilaktige ord.\n\n"
                f"----- DOKUMENTINNHOLD -----\n{kombinert_kontekst}"
            )
        },
    ]

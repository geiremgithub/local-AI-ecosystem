...
SKRIPT_VERSJON = "v42-flere-mapper-og-undermapper"
    ...
    meldinger = [
        {
            ...
            "content": (
                ...
                "Hvis brukeren spør om et vilkår (f.eks. 'må man være X'), skal du svare entydig 'Ja' eller 'Nei' basert på dokumentet, og deretter forklare regelen kort."

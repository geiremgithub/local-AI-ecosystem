...
# Fjerner konflikten mellom modellens standard 'max_length' og vårt eget
# 'max_new_tokens' - se forklaring i README/chat om disse advarslene
ai_modell.model.generation_config.max_length = None
